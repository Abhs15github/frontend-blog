...
// import logo from "../imgs/JB4JB-BLOG-LOGO.PNG";
...
const Navbar = () => {
  ...
  return (
    <>
    {/* <nav className="navbar z-50"></nav> */}
      <nav className="navbar z-50" style={{ backgroundColor: '#1c1c1c' }}>
...
<input
  type="text"
  placeholder="Search"
  className="w-full md:w-auto p-4 pl-6 pr-[12%] md:pr-6 rounded-full placeholder-text-dark-grey md:pl-12"
