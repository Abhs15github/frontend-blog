...
const ProfilePage = () => {
    ...
    // if (!profile) {
    //     return <h1>Loading...</h1>; // Render a loading state while fetching the profile
    // }
  ...
  <img src={profile_img} className="w-48 h-48 md:w-32 md:h-32 rounded-full bg-gray-200" alt="Profile" />
